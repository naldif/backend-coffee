...
<div class="topbar-left">
    <a href="index.html" class="logo">
        <img src="{{ asset('/be/assets/images/logo-light.png') }}" class="logo-lg" alt="" height="22">
        <img src="{{ asset('/be/assets/images/logo-sm.png') }}" class="logo-sm" alt="" height="24">
    </a>
</div>
        ...
        <li class="dropdown notification-list list-inline-item">
            <div class="dropdown notification-list nav-pro-img">
                <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#"
                    ...
                    <img src="{{ asset('/be/assets/images/users/user-1.jpg') }}" alt="user" class="rounded-circle">
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                    <!-- item-->
                    <a class="dropdown-item" href="#"></i>Hello, {{ Auth::user()->name }}</a>
